...
const content = {
  ...
  surveys: [
    {
      ...
      questions: [
        {
          id: "q1",
          title: "주일 아침, 교회에 갈 때 당신이 가장 기대하는 것은?",
          options: [
            {
              id: "q1-o1",
              label: "장엄하고 경건한 예배와 성찬",
              scores: [
                {
                  persona: "Liturgical",
                  weight: 1
        ...
        {
          id: "q2",
          title: "나는 성경을 어떻게 읽고 묵상하나요?",
          options: [
            {
              id: "q2-o1",
              label: "문맥과 단어를 분석하고, 역사적 배경까지 파고든다.",
              scores: [
                {
                  persona: "Intellectual",
                  weight: 1
            ...
            {
              id: "q2-o2",
              label: "일점일획도 틀림없는 절대 진리로 굳게 믿으며 새긴다.",
              scores: [
                {
                  persona: "Orthodox",
                  weight: 1
            ...
            {
              id: "q2-o4",
              label: "마음에 울려오는 성령님의 목소리를 들으려 한다.",
              scores: [
                {
                  persona: "Charismatic",
                  weight: 1
            ...
            {
              id: "q2-o5",
              label: "고대의 경전이 아니라 오늘의 상황과 맥락에서 재해석한다.",
              scores: [
                {
                  persona: "Progressive",
                  weight: 1
        ...
        {
          id: "q6",
          title: "다음 중 어떤 기도가 가장 좋다고 생각하나요?",
          options: [
            {
              id: "q6-o1",
        ...
        },
        {
          ...
          options: [
            {
              id: "q8-o1",
              label: "시대의 변화를 무시하고 옛전통과 교리만 고수하는 교회",
              scores: [
                {
                  persona: "Progressive",
                  weight: 1
            ...
            {
              id: "q8-o2",
              label: "감정만 앞서고 말씀과 교리의 깊이가 없는 교회",
              scores: [
                {
                  persona: "Intellectual",
                  weight: 1
            ...
            {
              id: "q8-o3",
              label: "예배가 너무 즉흥적이고 세속적인 이벤트 같은 교회",
              scores: [
                {
                  persona: "Liturgical",
                  weight: 1
        ...
        },
        {
          ...
          options: [
            ...
            {
              id: "q9-o2",
              label: "이성을 사용해 합리적으로 이해하고 설명할 수 있는 믿음",
              scores: [
                {
                  persona: "Intellectual",
                  weight: 1
            ...
            {
              id: "q9-o3",
              label: "이웃 사랑과 사회 정의를 위한 행동으로 드러나는 믿음",
              scores: [
                {
                  persona: "Social",
                  weight: 1
            ...
            {
              id: "q9-o4",
              label: "살아계신 하나님을 매일 느끼고 교제하는 믿음",
              scores: [
                {
                  persona: "Charismatic",
                  weight: 1
            ...
            {
              id: "q9-o5",
              label: "다름을 인정하고 환대와 포용의 가치를 드러내는 믿음",
              scores: [
                {
                  persona: "Progressive",
                  weight: 1
        ...
        {
          id: "q10",
          title: "역사 속 신앙의 선배들 중, 나의 가슴을 가장 뛰게 하는 인물은?",
          options: [
            {
              id: "q10-o1",
              label: "기독교의 뼈대와 교리를 세운 바울이나 칼빈",
              scores: [
                {
                  persona: "Intellectual",
                  weight: 1
            ...
            {
              id: "q10-o4",
              label: "침묵과 수행으로 영적 진리를 파고든 사막의 교부와 수도사들",
              scores: [
                {
                  persona: "Liturgical",
                  weight: 1
            ...
            {
              id: "q10-o5",
              label: "시대의 아픔에 공감하며 목소리 내고 실천한 사회적 활동가들",
              scores: [
                {
                  persona: "Progressive",
                  weight: 1
        ...
        {
          id: "q11",
          title: "주일 예배 외에, 나의 신앙을 가장 자라게 하는 것은?",
          options: [
            {
              id: "q11-o1",
              label: "신학/신앙 서적 독서모임이나 스터디",
              scores: [
                {
                  persona: "Intellectual",
                  weight: 1
            ...
            {
              id: "q11-o2",
              label: "새벽기도나 금요철야, LGM에서 드리는 뜨거운 찬양과 기도",
              scores: [
                {
                  persona: "Charismatic",
                  weight: 1
            ...
            {
              id: "q11-o5",
              label: "매일 꾸준히 하는 개인 묵상과 PBS, DPM",
              scores: [
                {
                  persona: "Liturgical",
                  weight: 1
        ...
        {
          id: "q12",
          title: "교회나 공동체에서 의견 충돌이나 갈등이 생겼을 때 어떻게 해야 할까?",
          options: [
            {
              id: "q12-o1",
              label: "성경 말씀과 정해진 교회법의 원칙대로 단호하게 치리한다.",
              scores: [
                {
                  persona: "Orthodox",
                  weight: 1
        ...
        },
        {
          ...
          options: [
            {
              id: "q13-o1",
              label: "신앙에 어긋날 수 있으니 철저히 분별하고 거리를 둔다.",
              scores: [
                {
                  persona: "Orthodox",
                  weight: 1
        ...
        {
          id: "q14",
          title: "타 종교인이나 비신자를 대할 때 나의 입장은?",
          options: [
            {
              id: "q14-o1",
        ...
        {
          id: "q15",
          title: "만약 어쩔 수 없이 교회를 옮기게 된다면, 결정적인 이유는?",
          options: [
            {
              id: "q15-o1",
              label: "설교가 성경적이지 않고 복음의 본질이 없어서",
              scores: [
                {
                  persona: "Orthodox",
                  weight: 1
            ...
            {
              id: "q15-o2",
              label: "교회의 운영 방식이 비합리적이고 반지성적이어서",
              scores: [
                {
                  persona: "Intellectual",
                  weight: 1
            ...
            {
              id: "q15-o3",
              label: "교회가 시대의 아픔이나 사회적 약자를 외면하고 차별해서",
              scores: [
                {
                  persona: "Progressive",
                  weight: 1
            ...
            {
              id: "q15-o4",
              label: "예배에 성령의 임재가 사라지고 감격이 없어서",
              scores: [
                {
                  persona: "Charismatic",
                  weight: 1
            ...
            {
              id: "q15-o5",
              label: "성도 간의 사랑과 공동체성이 부족하고 관계가 깨져서",
              scores: [
                {
                  persona: "Relational",
                  weight: 1
    ...
    },
    {
      ...
      questions: [
        {
          id: "nutri-q1",
          title: "설교를 듣거나 성경공부를 할 때 논리적이고 이성적으로 이해하기",
          options: [
            {
              id: "nutri-q1-yes",
              label: "💊 필요해",
        ...
        {
          id: "nutri-q3",
          title: "무조건 믿는게 아니라 이성적이고 합리적인 변증 배우기",
          options: [
            {
              id: "nutri-q3-yes",
              label: "💊 필요해",
        ...
        {
          id: "nutri-q7",
          title: "기후 위기, 성차별, 부정선거 등 현실 사회 문제에 대한 적극적 참여",
          options: [
            {
              id: "nutri-q7-yes",
              label: "💊 필요해",
        ...
        {
          id: "nutri-q8",
          title: "'우리끼리의 은혜'를 넘어 세상과 이웃을 위한 직접 행동",
          options: [
            {
              id: "nutri-q8-yes",
              label: "💊 필요해",
        ...
        {
          id: "nutri-q11",
          title: "시끌벅적한 모임 대신 혼자 기도하고 묵상하기",
          options: [
            {
              id: "nutri-q11-yes",
              label: "💊 필요해",
        ...
        {
          id: "nutri-q12",
          title: "어떤 상황이나 주변의 말에 흔들리지 않는 단단한 마음의 평안",
          options: [
            {
              id: "nutri-q12-yes",
              label: "💊 필요해",
        ...
        {
          id: "nutri-q14",
          title: "낡은 신앙의 틀을 깨고 내 신앙을 새롭게 세우기",
          options: [
            {
              id: "nutri-q14-yes",
              label: "💊 필요해",
        ...
        {
          id: "nutri-q15",
          title: "왜곡되고 맹목적 신앙의 습관을 고치고 바로서기",
          options: [
            {
              id: "nutri-q15-yes",
              label: "💊 필요해",
  ...
  personaResults: {
    Orthodox: {
      ...
      growthRoutine: "교리문답이나 신앙고백서 공부하기, 말씀 묵상 후 오늘 지킬 신앙의 기준을 한 문장으로 정리하기.",
  ...
  nutritionResults: {
    CARB: {
      ...
      recommendation: "청어람에는 함께 배우고 지적 근육을 키우는 다양한 북클럽과 신학, 인문학 강좌가 있습니다. 특히 온라인 챌린지로 진행하는 '읽는 신학교'를 추천해요!",
      cta: "청어람 뉴스레터와 인스타를 팔로우하고 소식을 받아보세요."
    },
    PROTEIN: {
      key: "PROTEIN",
      title: "🫛 관계의 단백질",
      ...
      recommendation: "청어람에는 어떤 주제를 두고 서로 평등하고 안전하게 대화하는 대화모임이 있습니다. 또 초대손님을 불러 이야기를 듣고 나누는 살롱 청어람도 있어요.",
      cta: "청어람 뉴스레터와 인스타를 팔로우하고 소식을 받아보세요."
    },
    VITAMIN: {
      key: "VITAMIN",
      ...
      recommendation: "청어람은 신앙이 단순히 사적인 것이 아니라 공적인 것이며, 특히 기독교는 고통받는 모든 존재들과 연결되고 얽혀있다고 믿습니다. 공공신학이나 사회이슈에 대한 북클럽, 젠더나 비거니즘에 대한 학습과 연대, 참여적 활동을 하고 있어요.",
      cta: "청어람 뉴스레터와 인스타를 팔로우하고 소식을 받아보세요."
    },
    MINERAL: {
      key: "MINERAL",
      ...
      recommendation: "청어람은 매일의 일상을 성실히 살아가도록 돕는 프로그램들도 있습니다. 매일 성서일과를 따라 묵상하는 성서일과 원정대, 시와 기도의 언어를 배우는 시모임, 쓰는기도모임, 한달에 두번 모이는 소박한 예배모임 등을 통해 일상의 영성을 훈련합니다.",
      cta: "청어람 뉴스레터와 인스타를 팔로우하고 소식을 받아보세요."
    },
    PROBIOTICS: {
      key: "PROBIOTICS",
      ...
      recommendation: "청어람은 항상 잘못된 관습이나 제도, 전통을 개혁하고 새로운 신앙으로 나아가는 운동입니다. 가나안 성도를 위한 주일 모임, 신앙의 해체와 재구성을 위한 세속성자 북클럽 등을 상시 열고 있습니다.",
      cta: "청어람 뉴스레터와 인스타를 팔로우하고 소식을 받아보세요."
    }
  }
} as Partial<TestContent>;

export const ivfTestContent: TestContent = createTestContent(content);
